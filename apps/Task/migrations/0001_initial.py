    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Assigned_to', models.ManyToManyField(to='Task.employee_assigned')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('Assigned_members', models.ManyToManyField(to='Task.employee_assigned')),
                ('Equipments', models.ManyToManyField(to='Task.equipments')),
                ('Inventory', models.ManyToManyField(to='Task.inventory')),
