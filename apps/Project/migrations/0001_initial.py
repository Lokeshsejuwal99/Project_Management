    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Assigned_to', models.ManyToManyField(to='Project.employee_assigned')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('Assigned_members', models.ManyToManyField(to='Project.employee_assigned')),
                ('Equipments', models.ManyToManyField(to='Project.equipments')),
                ('Inventory', models.ManyToManyField(to='Project.inventory')),
